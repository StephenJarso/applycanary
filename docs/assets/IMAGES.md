...
| `architecture.pdf` | 1600×1040 pt | Same diagram, vector-crisp PDF (dark theme baked in, no margins) — the exact file to attach to the submission form | **Submission attachment**, printed handouts |
| `architecture-a4.pdf` | A4 landscape (842×596 pt) | The same diagram scaled to standard A4-landscape paper with a matching letterbox | Submission forms that enforce A4 paper size |
